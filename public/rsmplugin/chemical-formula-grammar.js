...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c19 = function(formulas, multiplier) {
            return { formulas, multiplier };
          },
        peg$c20 = function(chemicalElement, multiplier) {
            return {
              chemicalElement,
              multiplier
            };
    ...
    function peg$parseFactor() {
      ...
      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parseChemicalElementWithMultiplier();
      if (s2 !== peg$FAILED) {
        while (s2 !== peg$FAILED) {
          s1.push(s2);
          s2 = peg$parseChemicalElementWithMultiplier();
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s1 !== peg$FAILED) {
          s2 = [];
          s3 = peg$parseChemicalElementWithMultiplier();
          if (s3 !== peg$FAILED) {
            while (s3 !== peg$FAILED) {
              s2.push(s3);
              s3 = peg$parseChemicalElementWithMultiplier();
    ...
    function peg$parseChemicalElementWithMultiplier() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = peg$parseChemicalElement();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseInteger();
        if (s2 === peg$FAILED) {
          s2 = null;
