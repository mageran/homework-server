...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c29 = "\\sqrt",
      peg$c30 = peg$literalExpectation("\\sqrt", false),
      peg$c31 = "[",
      ...
      peg$c37 = function(degree, radicand) {
          const obj = { op: 'sqrt', degree: degree? degree[1] : 2, radicand };
          return obj;
        },
      peg$c38 = "|",
      peg$c39 = peg$literalExpectation("|", false),
      peg$c40 = function(expr) { return { op: 'abs', operands: [expr] }; },
      peg$c41 = function(p) { return p; },
      peg$c42 = "\\sin",
      peg$c43 = peg$literalExpectation("\\sin", false),
      peg$c44 = "\\cos",
      peg$c45 = peg$literalExpectation("\\cos", false),
      peg$c46 = "\\tan",
      peg$c47 = peg$literalExpectation("\\tan", false),
      peg$c48 = "\\cot",
      peg$c49 = peg$literalExpectation("\\cot", false),
      peg$c50 = "\\sec",
      peg$c51 = peg$literalExpectation("\\sec", false),
      peg$c52 = "\\csc",
      peg$c53 = peg$literalExpectation("\\csc", false),
      peg$c54 = function() { return text() },
      peg$c55 = peg$otherExpectation("integer"),
      peg$c56 = /^[0-9]/,
      peg$c57 = peg$classExpectation([["0", "9"]], false, false),
      peg$c58 = function() { return new Decimal(text()); },
      peg$c59 = peg$otherExpectation("float"),
      peg$c60 = ".",
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s4 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          s6 = peg$parse_();
          if (s6 !== peg$FAILED) {
            s7 = peg$parseMaybeCurlyExpression();
            if (s7 !== peg$FAILED) {
              s4 = [s4, s5, s6, s7];
              s3 = s4;
            } else {
  ...
  function peg$parseMaybeCurlyExpression() {
